...
export const getMovieCredits = async (movie_id) => { 
    try {
        const response = await axios.get(`./movie/${movie_id}/credits?api_key=${API_KEY}&page=1`)
...
export const getMovieReviews = async (movie_id) => { 
    try {
        const response = await axios.get(`./movie/${movie_id}/reviews?api_key=${API_KEY}&page=1`)
